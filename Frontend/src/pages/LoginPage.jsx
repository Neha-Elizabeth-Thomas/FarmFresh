...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-150px)] bg-white flex items-center justify-center p-4">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
        ...
        <div className="flex justify-center">
          <div className="relative w-full max-w-md">
            <div className="absolute inset-0 bg-gray-100 transform -skew-y-6 rounded-lg z-0"></div>
            <div className="relative bg-white p-8 rounded-lg shadow-lg z-10">
              ...
              <div className="text-center mt-6">
                <Link to="/forgot-password" className="text-sm text-gray-600 hover:text-green-600">
                  Forgot Password?
                </Link>
              </div>
